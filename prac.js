...
function draw() {
 ...
 if(mouseX<600&&mouseX>149 && mouseY<390){
   fill(r,g,b);
   quad(149,0,600,0,600,390,149,390);
 }
 if(mouseX>149 && mouseX<495 && mouseY>411 && mouseY<600){
   fill(r,g,b);
   quad(149,411,495,411,495,600,149,600);
 }
 if(mouseX>517 && mouseY>411 && mouseY<484&&mouseX<600){
   fill(r,g,b);
   quad(517,411,600,411,600,484,517,484);
 }
 if(mouseX>517 && mouseX<600 && mouseY>504 && mouseY<600){
   fill(r,g,b);
   quad(517,504,600,504,600,600,517,600);
 }
 if((mouseX>=130 && mouseX<=149 && mouseY<=600 )||
 (mouseY>=144 &&mouseY<=165 && mouseX<=149)||
 (mouseY>=390 &&mouseY<=411 && mouseX<=600)||
 (mouseX>=495 &&mouseX<=517 && mouseY>=390)||
